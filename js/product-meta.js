...
const PRODUCT_META = {
  ...
  // ── PAR PLANS ──────────────────────────────────────────
  'tata': { keyHighlights: ['Non-Linked Participating — choose Endowment / Early Income / Deferred Income at inception','Higher life cover: 12× Annual Premium vs standard 10×','Cover Continuance Benefit — policy stays active if premium missed','Waiver of Premium rider on disability or death of proposer','Reversionary Bonus + Terminal Bonus at maturity'], whySuit: 'Choose Tata AIA Shubh Flexi Income for flexibility to decide between savings or income output at policy inception.', bestFor: 'Individuals who want a participating plan but want to choose lump sum vs income payout.', limitations: ['Participating — bonus not guaranteed'], scoreData: { flexibility:9, protection:8, income:6, riders:6, loan:5, jointLife:7 } },
  'bajaj': { keyHighlights: ['Non-Linked Participating Endowment with bonus potential','Income option with income increasing at 5% per annum','Multiple PPT options from 5 to 12 years','Life cover throughout the policy term','Flexibility to choose Lump Sum or Income at inception'], whySuit: 'Choose Bajaj Life ACE for a participating plan with growing income potential at 5% per year.', bestFor: 'Individuals comfortable with participating plans who want bonus upside and income growth.', limitations: ['Participating — bonus not guaranteed','Illustration data pending'], scoreData: { flexibility:7, protection:6, income:6, riders:5, loan:4, jointLife:6 } },
  'pnb': { keyHighlights: ['Non-Linked Participating Savings from PNB MetLife','Backed by PNB — one of India's largest public sector banks','Bonus-linked growth on top of guaranteed savings','Life cover throughout the policy term','Available through PNB branches nationwide'], whySuit: 'Choose PNB MetLife Super Saver for bank-backed savings with bonus potential.', bestFor: 'PNB bank customers seeking savings plan through their existing bank.', limitations: ['Participating — bonus not guaranteed'], scoreData: { flexibility:6, protection:6, income:4, riders:5, loan:5, jointLife:5 } },
  'lic': { keyHighlights: ['LIC — Government of India backing, sovereign guarantee','Simple Reversionary Bonus + Final Additional Bonus at maturity','Loan facility available after 3 policy years','Death benefit: Sum Assured + accrued bonuses','Widest branch network — claim settlement across India'], whySuit: 'Choose LIC New Endowment Plan 714 if government backing is the primary requirement.', bestFor: 'Conservative investors who prioritise sovereign guarantee above all else.', limitations: ['PPT 10 + PT 20 NOT available under this plan','Regular Pay only — PPT equals PT'], scoreData: { flexibility:3, protection:7, income:0, riders:4, loan:8, jointLife:5 } },

  // ── NISHCHIT EARLY INCOME ───────────────────────────────
  'icici': { keyHighlights: ['Instant cashback of ₹50,000 at policy issuance — immediate liquidity','Guaranteed income from Year 2, increasing at 5% compound annually','100% of total premiums returned as maturity benefit','Non-Linked, Non-Participating — all benefits fully guaranteed','Income continues for 19 years with growing purchasing power'], whySuit: 'Choose ICICI Pru GIFT Select for immediate liquidity (₹50K cashback) and growing income to beat inflation.', bestFor: 'Customers who need immediate cash at policy start AND want income that grows over time.', limitations: ['Income starts from Year 2 — not Year 1','Growing income means lower initial income vs level plans'], scoreData: { flexibility:7, protection:7, income:9, riders:5, loan:7, jointLife:5 } },
  'axis': { keyHighlights: ['Guaranteed income from Year 1 — zero deferment period','Non-Linked, Non-Participating — all returns fully guaranteed','Multiple policy term options for planning flexibility','Life cover throughout the income period','Axis Max Life — one of India's leading private insurers'], whySuit: 'Choose Axis Max Life SWAG Early Wealth for guaranteed early income from Year 1 with multiple term options.', bestFor: 'Customers seeking early guaranteed income from a large private insurer.', limitations: ['Illustration for PT 20 pending — current data based on PT 30'], scoreData: { flexibility:6, protection:7, income:9, riders:5, loan:4, jointLife:4 } },
  ...
  'sav_HDFC Life': { keyHighlights: ['Non-Linked, Non-Participating — guaranteed lump sum at maturity','Single Pay or Limited Pay options for flexibility','Guaranteed Additions to enhance corpus during policy term','HDFC Life — India's largest private life insurer by AUM','Simple, transparent, fixed maturity structure'], whySuit: 'Choose HDFC Life Sanchay Fixed Maturity for a straightforward guaranteed lump sum from India's largest private insurer.', bestFor: 'Customers who prefer simplicity and strong brand backing.', limitations: ['Limited PPT options vs competitors','Fewer riders'], scoreData: { flexibility:5, protection:7, income:0, riders:4, loan:5, jointLife:5 } },
  'sav_Bajaj Life': { keyHighlights: ['Participating plan — guaranteed amount + potential bonus upside','Flexibility between lump sum and income at inception','Bonus linked to company performance','Life cover throughout the policy term','Multiple PPT options available'], whySuit: 'Choose Bajaj Life ACE Savings for bonus upside potential alongside guaranteed savings.', bestFor: 'Individuals comfortable with participating structure who want bonus growth potential.', limitations: ['Participating — bonus NOT guaranteed','Different structure from Non-Par benchmark'], scoreData: { flexibility:7, protection:6, income:3, riders:5, loan:4, jointLife:5 } },
  ...
  // ── ANNUITY PLANS ────────────────────────────────────────
  'ann_lic-jak': { keyHighlights: ['LIC Jeevan Akshay VII — government-backed sovereign guarantee','10 annuity options: Single Life, Joint Life, Certain Period, ROP','Annuity Certain: guaranteed payout for 5–20 years even if annuitant dies','Joint Life — 50% annuity continues to spouse on primary's death','100% Return of Purchase Price option on death'], whySuit: 'Choose LIC Jeevan Akshay VII for the ultimate security of government-backed lifetime annuity.', bestFor: 'Retirees who prioritise absolute security and sovereign guarantee above all features.', limitations: ['No Deferred option','No NPS variant','No CI Enhancement'], scoreData: { flexibility:7, protection:8, income:10, riders:3, loan:5, jointLife:9 } },
  'ann_lic-smart': { keyHighlights: ['LIC Smart Pension Plan 879 — LIC newest annuity plan (Feb 2025)','E-series: Return of Purchase Price at age 75 or 80 to living annuitant','NPS-compatible option available for NPS subscribers','10+ annuity variants including joint life and single life','LIC government backing with modern plan features'], whySuit: 'Choose LIC Smart Pension Plan 879 for LIC newest annuity with living benefits and NPS compatibility.', bestFor: 'NPS subscribers who want LIC government backing with modern annuity features.', limitations: ['E-series ROP structure differs from ABSLI living annuitant benefit','No CI Enhancement option'], scoreData: { flexibility:8, protection:8, income:10, riders:3, loan:5, jointLife:9 } },
  'ann_lic-njs': { keyHighlights: ['LIC New Jeevan Shanti 758 — deferred annuity specialist','Guaranteed Additions during the deferment period','Choose deferment period from 1 to 12 years','Joint Life and Single Life options','LIC sovereign guarantee throughout accumulation and payout'], whySuit: 'Choose LIC New Jeevan Shanti 758 to lock in annuity rates now and start income after 5–10 years.', bestFor: 'Pre-retirees aged 45–60 who want to plan annuity income in advance with government backing.', limitations: ['Deferred annuity only — not suitable for immediate income requirement'], scoreData: { flexibility:7, protection:7, income:9, riders:3, loan:4, jointLife:8 } },
  'ann_hdfc-pgp': { keyHighlights: ['HDFC Life Pension Guaranteed Plan — deferred + immediate options','Guaranteed Additions during accumulation phase','HDFC Life — India's largest private life insurer','Multiple annuity payout frequency options','Joint Life annuity with ROP option'], whySuit: 'Choose HDFC Life Pension Guaranteed Plan for deferred annuity from India's largest private insurer.', bestFor: 'Pre-retirees wanting guaranteed corpus growth before converting to lifetime income.', limitations: ['Verify current annuity rates at HDFC Life official calculator'], scoreData: { flexibility:7, protection:7, income:9, riders:3, loan:4, jointLife:8 } },
  'ann_hdfc-niap': { keyHighlights: ['HDFC Life New Immediate Annuity Plan — lifelong guaranteed income','Multiple options: Single Life, Joint Life, ROP on death','CI option: Return of Purchase Price on 6 critical illnesses','HDFC Life — strongest brand in private life insurance','Joint Life annuity continues to spouse after primary's death'], whySuit: 'Choose HDFC Life New Immediate Annuity for immediate lifelong income with India's largest private insurer.', bestFor: 'Retirees who want immediate income with joint life protection and strong brand assurance.', limitations: ['CI option: annuity CEASES on CI trigger (ABSLI enhances annuity by 50%)','Only 6 CIs covered vs ABSLI's 42'], scoreData: { flexibility:6, protection:8, income:10, riders:3, loan:4, jointLife:9 } },
  'ann_icici': { keyHighlights: ['ICICI Pru Guaranteed Pension Plan — immediate and deferred annuity','Multiple options: Single Life, Joint Life, Certain Period','ICICI Pru — top 3 private life insurer by market share','Deferred variant with growing corpus during deferment','Return of Purchase Price option on death'], whySuit: 'Choose ICICI Pru Guaranteed Pension Plan for reliable lifetime annuity from India's top private insurer.', bestFor: 'Retirees who want immediate annuity income from a financially strong top-brand private insurer.', limitations: ['Verify current annuity rates from official ICICI Pru calculator'], scoreData: { flexibility:7, protection:7, income:10, riders:3, loan:5, jointLife:8 } },
  'ann_sbi': { keyHighlights: ['SBI Life Saral Pension — IRDAI standardised annuity product','Mandatory 100% Return of Purchase Price on death (IRDAI rule)','Joint Life — 50% annuity continues to surviving spouse','SBI Life — backed by India's largest bank','Policy loan available after just 6 months'], whySuit: 'Choose SBI Life Saral Pension for IRDAI-standardised simplicity with SBI bank backing.', bestFor: 'SBI customers who want a simple, no-frills annuity with mandatory ROP and bank trust.', limitations: ['Very limited options — 2 variants only (IRDAI Saral standard)','No CI, no deferred, no NPS option'], scoreData: { flexibility:3, protection:7, income:10, riders:2, loan:8, jointLife:8 } },
  'ann_tata': { keyHighlights: ['Tata AIA Smart Annuity Plan — comprehensive options','Single Life and Joint Life with ROP variants','Annuity Certain: guaranteed for chosen period even on death','Tata AIA — JV of Tata Group and AIA (Asia's largest insurer)','Strong claim settlement ratio consistently'], whySuit: 'Choose Tata AIA Smart Annuity Plan for comprehensive annuity with Tata + AIA's combined strength.', bestFor: 'Retirees who value international insurer backing (AIA) alongside trusted Tata brand.', limitations: ['Fewer unique features vs ABSLI Guaranteed Annuity Plus'], scoreData: { flexibility:7, protection:7, income:10, riders:3, loan:4, jointLife:8 } },
  'ann_bajaj': { keyHighlights: ['Bajaj Life Guaranteed Pension Goal II — immediate annuity','Multiple variants: Single Life, Joint Life, ROP options','Bajaj Finserv Group — India's largest financial conglomerate','Guaranteed lifelong income with no market risk','Return of Purchase Price option on death'], whySuit: 'Choose Bajaj Life Guaranteed Pension Goal II for lifetime annuity from Bajaj Finserv group.', bestFor: 'Bajaj brand customers seeking guaranteed annuity income with conglomerate backing.', limitations: ['Company renamed from Bajaj Allianz to Bajaj Life — verify current brochure'], scoreData: { flexibility:6, protection:7, income:10, riders:3, loan:4, jointLife:8 } },
  'ann_kotak': { keyHighlights: ['Kotak Life Assured Pension — immediate annuity plan','Joint Life, Single Life, Annuity Certain variants','CI Option available: ROP on critical illness or death','Kotak Life — consistently top-ranked for service quality','Deferred annuity option with growing corpus'], whySuit: 'Choose Kotak Life Assured Pension for guaranteed annuity with Kotak's top-ranked customer service.', bestFor: 'Retirees who value service quality and claim responsiveness alongside guaranteed lifetime income.', limitations: ['CI option: annuity ceases on CI trigger (ABSLI enhances by 50%)'], scoreData: { flexibility:7, protection:7, income:10, riders:4, loan:4, jointLife:8 } },
  'ann_pnb': { keyHighlights: ['PNB MetLife Immediate Annuity — bank-backed annuity','Multiple options: Single Life, Joint Life, Certain Period','PNB MetLife — JV of Punjab National Bank and MetLife','Guaranteed lifelong income with no market risk','Available through PNB bank branches Pan India'], whySuit: 'Choose PNB MetLife Immediate Annuity for guaranteed lifetime income through PNB bank network.', bestFor: 'PNB bank customers who want annuity through their existing banking relationship.', limitations: ['Fewer unique features vs market leaders'], scoreData: { flexibility:5, protection:6, income:10, riders:3, loan:4, jointLife:7 } },
  'ann_axis': { keyHighlights: ['Axis Max Life Guaranteed Lifetime Income Plan — immediate annuity','Single Life and Joint Life options with ROP variants','Axis Max Life — strong claim settlement ratio','Guaranteed lifelong income — no market dependency','Return of Purchase Price on death option'], whySuit: 'Choose Axis Max Life Guaranteed Lifetime Income Plan for reliable lifetime annuity from a performance-focused private insurer.', bestFor: 'Retirees who want guaranteed income with strong claim settlement assurance.', limitations: ['Fewer unique options vs market leaders','Verify current rates from official calculator'], scoreData: { flexibility:6, protection:7, income:10, riders:3, loan:4, jointLife:8 } },
  'ann_canara-p4l': { keyHighlights: ['Canara HSBC Pension4Life — bank-backed annuity plan','Multiple annuity variants including Joint Life','NPS-compatible option for NPS subscribers','Canara HSBC Life — backed by Canara Bank + HSBC','Guaranteed lifelong income from first payout'], whySuit: 'Choose Canara HSBC Pension4Life for NPS-compatible annuity through a bank-backed insurer.', bestFor: 'NPS subscribers or Canara Bank customers who want guaranteed annuity at retirement.', limitations: ['Verify current annuity rates and options from official brochure'], scoreData: { flexibility:6, protection:6, income:10, riders:3, loan:4, jointLife:7 } },
  'ann_canara-sgp': { keyHighlights: ['Canara HSBC Smart Guaranteed Pension — deferred + immediate annuity','Guaranteed Additions during deferment period','Canara HSBC Life — trusted bank-backed insurer','Flexible deferment period options','Converts accumulated corpus to guaranteed lifetime income'], whySuit: 'Choose Canara HSBC Smart Guaranteed Pension for deferred annuity with guaranteed growth during accumulation.', bestFor: 'Pre-retirees who want bank-backed plan to accumulate corpus now and start income at retirement.', limitations: ['Verify current product features from official brochure'], scoreData: { flexibility:6, protection:6, income:9, riders:3, loan:4, jointLife:7 } },
